...
public class CompanyController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<String> setCompany(@PathVariable Long id, @RequestBody Company company){
    ...
    public ResponseEntity<String> deleteCompany(@PathVariable Long id){
        ...
        return new ResponseEntity<>("Company not available" ,HttpStatus.BAD_REQUEST);
    }
